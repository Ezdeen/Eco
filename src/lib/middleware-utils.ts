...
export const RATE_LIMITS = {
  ...
  // Public solar calculator — لا يتطلب مصادقة، لذا الحد صارم نسبيًا لمنع تسميم
  // قاعدة العملاء المحتملين (leads) أو استنزاف توليد PDF
  solarCalculatorLead: { maxRequests: 8, windowMs: 10 * 60 * 1000 }, // 8 عمليات إرسال كل 10 دقائق لكل IP
  solarCalculatorPdf: { maxRequests: 15, windowMs: 10 * 60 * 1000 }, // 15 تحميل PDF كل 10 دقائق لكل IP
